...
export default function NotFound() {
  return (
    <section className="min-h-[100svh] flex flex-col items-start justify-center px-5 md:px-8 pt-[var(--nav-h)]">
      ...
      <h1 className="headline text-[clamp(3rem,10vw,7rem)]">Non c&apos;è.</h1>
      <p className="mt-4 max-w-md text-inchiostro/75">Questa pagina non esiste o il capo è finito. Torna alla collezione.</p>
